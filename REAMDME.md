...
The best model (Gradient Boosting) achieved a validation AUC of ~87%, with a Kaggle public leaderboard AUC of ~86%.
...
- Use feature importance or SHAP for model explainability
